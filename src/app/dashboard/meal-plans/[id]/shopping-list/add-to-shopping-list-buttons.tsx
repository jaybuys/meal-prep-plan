...
export function AddIngredientButton({ ingredient }: { ingredient: ShoppingIngredient }) {
...
export function AddAllToShoppingListButton({
  ingredients,
}: {
    ...
    >
      {added ? (
        ...
        <>
          ...
          {isPending ? "Adding..." : "Add all to my shopping list"}
        </>
      )}
    </Button>
  );
